...
function getProductsArray(products) {
    let productsCache = [];
    products.forEach(p => {
        let prod = new Product(p.id, `${p.name} - ${p.brand.name}`,p.description, p.dateReleased, p.img, p.price);
        ...
        <div class="col-lg-5 col-md-6">
            <div class="banner-content">
                ...
                <div class="add-bag d-flex align-items-center">
                    ...
                    <span class="add-text text-uppercase">into cart</span>
                </div>
            </div>
        </div>
        <div class="col-lg-7">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="prd-bottom mt-0">
                    <a data-id="${product.id}" href="#" class="social-info addToCart">
                        ...
                        <p class="hover-text">into cart</p>
                    </a>
                </div>
            </div>
        </div>
